			...
			<center>
				...
				$(function(){
			        ...
			        $('.replyDeletebtn').on("click",function () {
						...
						var delfrm = $(".replyDeletefrm").serialize();
						console.log("delfrm: " + delfrm);
						...
						<c:forEach var="reply" items="${replyList}">
							<table width="80%" border="1">
								...
								<tr align="left">
									...
									<form class="replyDeletefrm" name="replyDel">
										<input type="hidden" name="no" value="${reply.no}"> 
										<input type="hidden" name="idx" value="${idx}"> 
										password :<input type="password" name="delPwd" class="delpwd" size="4"> 
